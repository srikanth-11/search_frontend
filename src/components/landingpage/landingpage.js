    ...
    <Headroom>
      <header className="header">
        <a href="#" className="logo">
          ...
          <span className="logo-name">Simplesearch<sup>2</sup></span>
          <span className="grey-color"></span>
        </a>
          ...
          <div className="greeting-text-div">
            <div>
              <h1 className="greeting-text" id="type">
                ...
                <span>welcome to Simplesearch<sup>2</sup></span>

                {" "}

              </h1>
              <p className="greeting-text-p subTitle">Know about the business around you</p>
